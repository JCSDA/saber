...
module saber_unstructured_interpolation_mod
...
implicit none
private
public saber_unstrc_interp
public saber_unstrc_interp_registry

!---------------------------------------------------------------------------------------------------

type saber_unstrc_interp
...
endtype saber_unstrc_interp

! ------------------------------------------------------------------------------
!> Registry for saber_unstrc_interp objects

#define LISTED_TYPE saber_unstrc_interp

!> Linked list interface - defines registry_t type
#include "oops/util/linkedList_i.f"

!> Global registry
type(registry_t) :: saber_unstrc_interp_registry
...
class(saber_unstrc_interp), intent(inout) :: self                ! Myself
...
class(saber_unstrc_interp), intent(inout) :: self
...
class(saber_unstrc_interp),           intent(in)  :: self                                 ! Myself
...
class(saber_unstrc_interp),           intent(in) :: self
...
! Error check
if (procrank>999999) call abor1_ftn("saber_unstructured_interpolation_mod not ready for more than 999999 processors")
...
end module saber_unstructured_interpolation_mod
