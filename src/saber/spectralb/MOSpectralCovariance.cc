...
#include "saber/spectralb/MOSpectralCovariance.h"
...
static SaberCentralBlockMaker<MOSpectralCovariance>
  makerMOSpectralCovariance_("mo spectral covariance");

// -----------------------------------------------------------------------------
MOSpectralCovariance::MOSpectralCovariance(const oops::GeometryData & geometryData,
    ...
    timeRank_(timeRank)
{
  ...
  oops::Log::trace() << classname() << "::MOSpectralCovariance done" << std::endl;
}

// -----------------------------------------------------------------------------

void MOSpectralCovariance::randomize(atlas::FieldSet & fieldSet) const {
...
void MOSpectralCovariance::multiply(atlas::FieldSet & fieldSet) const {
...
void MOSpectralCovariance::read() {
...
void MOSpectralCovariance::print(std::ostream & os) const {
  os << classname();
}
