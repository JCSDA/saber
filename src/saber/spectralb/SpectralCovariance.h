...
class SpectralCovarianceParameters : public BlockParametersBase {
  OOPS_CONCRETE_PARAMETERS(SpectralCovarianceParameters, BlockParametersBase)
...
class SpectralCovariance : public CentralBlockBase {
 public:
