...
class HydroBalParameters : public BlockParametersBase {
  OOPS_CONCRETE_PARAMETERS(HydroBalParameters, BlockParametersBase)
...
class HydroBal : public OuterBlockBase {
 public:
