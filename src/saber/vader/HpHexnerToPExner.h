...
class HpHexnerToPExnerParameters : public BlockParametersBase {
  OOPS_CONCRETE_PARAMETERS(HpHexnerToPExnerParameters, BlockParametersBase)
...
class HpHexnerToPExner : public OuterBlockBase {
 public:
