...
class ResidualFieldsParameters : public BlockParametersBase {
  OOPS_CONCRETE_PARAMETERS(ResidualFieldsParameters, BlockParametersBase)
...
class ResidualFields : public OuterBlockBase {
 public:
