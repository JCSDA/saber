...
class NICASFilterParameters : public BlockParametersBase {
  OOPS_CONCRETE_PARAMETERS(NICASFilterParameters, BlockParametersBase)
...
class NICASFilter : public OuterBlockBase {
 public:
