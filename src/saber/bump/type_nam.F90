...
character(len=1024) :: datadir,prefix,prefix_input,model,verbosity,strategy,method,wind_filename,wind_varname(2),mask_type
character(len=1024) :: mask_lu(nvmax),draw_type,adv_type,minim_algo,fit_type,subsamp
