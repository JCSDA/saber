...
plot_list=["avg","diag","diag_dirac","dirac","lct","lct_cor","normality","randomization","sampling_grids","umf","var"]
done_list=["normality","sampling_grids","diag","diag_dirac","lct","lct_cor"]
done = {}
alias_list = {
   "avg": "avg",
   "diag": "diag",
