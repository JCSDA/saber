   ...
   for impi in range(0, int(mpi)):
      ...
      if sc3:
         for ic3 in ic3_plot:
            # Open workstation
            wks_type = "png"
            wks = Ngl.open_wks(wks_type, testfig + "/test_" + mpi + "-" + omp + "_" + suffix + "_" + group + "_c3_" + str(ic3))
      ...
      if sc3 and (local or vbal):
         ...
         # Open workstation
         wks_type = "png"
         wks = Ngl.open_wks(wks_type, testfig + "/test_" + mpi + "-" + omp + "_" + suffix + "_" + group + "_c2_in_c1")
      ...
      if local:
         ...
         for ic2 in ic2_plot:
            # Open workstation
            wks_type = "png"
            wks = Ngl.open_wks(wks_type, testfig + "/test_" + mpi + "-" + omp + "_" + suffix + "_" + group + "_c2_" + str(ic2))
