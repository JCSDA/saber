...
if run_horizontal and run_vertical:
   ...
   file.write("\n")
   file.write("private\n")
   file.write("public :: npk,nnl,nscaleth,scaleth,ipkhdef,ipkvdef,pkmin,pkmax,nlmin,nlmax,scalethmin,scalethmax,dpk,dnl,pk,nl,scaleh,scalev, &\n")
   file.write(" & support_hor,support_ver\n")
